...
/**
 * Sólo la rama `prod` se indexa. El entorno de test devuelve `disallow: /` para no competir en
 * Google con el dominio real por la búsqueda que más importa: su propio nombre.
